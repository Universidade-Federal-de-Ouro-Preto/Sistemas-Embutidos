...
module top ;
	...
	wire [0:0] tmpOE__pino_chave_net;
	wire [0:0] tmpIO_0__pino_chave_net;
	wire [0:0] tmpINTERRUPT_0__pino_chave_net;
	electrical [0:0] tmpSIOVREF__pino_chave_net;
	...
	cy_psoc3_pins_v1_10
		...
		pino_chave
		 (.oe(tmpOE__pino_chave_net),
		  .y({1'b0}),
		  .fb({Net_9}),
		  .io({tmpIO_0__pino_chave_net[0:0]}),
		  .siovref(tmpSIOVREF__pino_chave_net),
		  .interrupt({tmpINTERRUPT_0__pino_chave_net[0:0]}),
		  .annotation({Net_11}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__pino_chave_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__pino_LED_net;
	wire [0:0] tmpFB_0__pino_LED_net;
	wire [0:0] tmpIO_0__pino_LED_net;
	wire [0:0] tmpINTERRUPT_0__pino_LED_net;
	electrical [0:0] tmpSIOVREF__pino_LED_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		pino_LED
		 (.oe(tmpOE__pino_LED_net),
		  .y({Net_9}),
		  .fb({tmpFB_0__pino_LED_net[0:0]}),
		  .io({tmpIO_0__pino_LED_net[0:0]}),
		  .siovref(tmpSIOVREF__pino_LED_net),
		  .interrupt({tmpINTERRUPT_0__pino_LED_net[0:0]}),
		  .annotation({Net_3}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__pino_LED_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    cy_annotation_universal_v1_0 CHAVE_1 (
        .connect({
            Net_6,
            Net_11
        })
    );
    defparam CHAVE_1.comp_name = "SwitchSPST_v1_0";
    defparam CHAVE_1.port_names = "T1, T2";
    defparam CHAVE_1.width = 2;
